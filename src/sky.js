...
function sky(){
    ...
    let materialArray = [];
    let texture_ft = new THREE.TextureLoader().load('../res/textures/skybox/cocoa_ft.jpg');
    let texture_bk = new THREE.TextureLoader().load('../res/textures/skybox/cocoa_bk.jpg');
    let texture_up = new THREE.TextureLoader().load('../res/textures/skybox/cocoa_up.jpg');
    let texture_dn = new THREE.TextureLoader().load('../res/textures/skybox/cocoa_dn.jpg');
    let texture_rt = new THREE.TextureLoader().load('../res/textures/skybox/cocoa_rt.jpg');
    let texture_lf = new THREE.TextureLoader().load('../res/textures/skybox/cocoa_lf.jpg');
